...
SECRET_KEY = 'django-insecure-xqeoz&gh5h9-1y$un3xc-rbsl(^q7#tvy!dca%b#^k43@l^n5t'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bdd_incident_responder',  # Remplacez par le nom de votre base de données
        'USER': 'admin',              # Remplacez par votre nom d'utilisateur
        'PASSWORD': 'admin',         # Remplacez par votre mot de passe
        'HOST': '172.17.0.1',                       # Utilisez 'localhost' ou l'adresse IP du serveur
